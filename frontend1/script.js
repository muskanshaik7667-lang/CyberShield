...
const App = () => {
    ...
    const runSecurityScan = async () => {
        ...
        try {
            ...
            const severity = passRate > 80 ? "Low" : (passRate > 60 ? "Medium" : "Critical");
                    ...
                    <div className="space-y-8 animate-[fadeIn_0.5s_ease-out]">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                            ...
                            <div className="glass-panel p-5 rounded-lg text-center border-l-4 border-cyber-success">
                                <p className="text-slate-400 text-xs font-mono uppercase tracking-wider text-cyber-success">Shield Blocked (Pass)</p>
                                <p className="font-heading text-3xl font-bold mt-1 text-cyber-success">{report.pass_count}</p>
                            </div>
                            <div className="glass-panel p-5 rounded-lg text-center border-l-4 border-cyber-critical">
                                <p className="text-slate-400 text-xs font-mono uppercase tracking-wider text-cyber-critical">Exploited (Fail)</p>
                                <p className="font-heading text-3xl font-bold mt-1 text-cyber-critical">{report.fail_count}</p>
                            </div>
                            <div className="glass-panel p-5 rounded-lg text-center">
                                            ...
                                            <React.Fragment key={log.id}>
                                                ...
                                                >
                                                    ...
                                                    <td className="px-6 py-4">
                                                        <span className={`inline-block px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider ${log.verdict === 'pass' ? 'bg-cyber-success/10 border border-cyber-success/20 text-cyber-success' : 'bg-cyber-critical/10 border border-cyber-critical/20 text-cyber-critical'}`}>
                                                            {log.verdict}
                                                        </span>
                                                    </td>
